...
const HotelDetails = ({ hotels }) => {
  ...
  // Handle booking: Validate and pass data to Booking Summary
  const handleBooking = () => {
    ...
    if (!dateFrom || !dateTo || !room || !guests || !roomType) {
      ...
      // Pass the data to BookingSummary
      navigate("/BookingSummary", { state: bookingDetails });
    }
  };
    ...
    <div style={styles.container}>
      ...
      <div style={styles.detailsContainer}>
        <div style={styles.card}>
          ...
          <p>
            <strong>Total Price:</strong> ₹{hotel.price.toLocaleString()}
          </p>
          ...
          <div style={styles.section}>
            ...
            >
              ...
              <option value="1 Queen Bed Standard Non-Smoking">
