...
export const getAllRooms = () => async (dispatch) => {
  try {
    const res = await axios.get('https://hotel-booking-app-backend-4dcd.onrender.com/api/rooms');
...
export const updateRoom = (roomId, updatedData) => async (dispatch) => {
  try {
    const res = await axios.put(`https://hotel-booking-app-backend-4dcd.onrender.com/api/rooms/672afa425a4d81c9ae37325e${roomId}`, updatedData);
...
export const deleteRoom = (roomId) => async (dispatch) => {
  try {
    await axios.delete(`https://hotel-booking-app-backend-4dcd.onrender.com/api/rooms/672afa425a4d81c9ae37325e${roomId}`);
